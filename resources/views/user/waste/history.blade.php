                        ...
                        <tbody>
                            @forelse($submissions as $item)
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="bg-{{ $item->category->color ?? 'primary' }} text-white rounded-circle p-2 me-3"
                                                style="width: 40px; height: 40px;">
                                                <i class="{{ $item->category->icon ?? 'fas fa-trash ms-1' }}"></i>
                                            </div>
                                            <div>
                                                <div class="fw-bold">
                                                    {{ $item->category->name ?? 'Kategori tidak ditemukan' }}</div>
                                                <small class="text-muted">{{ $item->category->points_per_kg }}
                                                    pts/kg</small>
                                            </div>
                                        </div>
                                    </td>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-6">
                                                                ...
                                                                <div class="fw-bold">{{ $item->category->points_per_kg }}
                                                                    points</div>
                                                            </div>
                                                            <div class="col-6">
                                                                <small class="text-muted">Total Poin</small>
                                                                <div class="fw-bold">{{ $item->points ?? '-' }} points
                                                                </div>
                                                            </div>
                                                        </div>
                                                        @if ($item->note)
