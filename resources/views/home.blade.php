...
@section('content')
    ...
    <section class="hero-section position-relative overflow-hidden">
        ...
        <div class="hero-bg">
            <img src="{{ asset('images/tangan.png') }}" alt="Environmental Background" class="w-100 h-100 object-fit-cover"
                ...
                <div class="col-lg-6">
                    <div class="hero-content">
                        ...
                        <p class="hero-description">
                            Platform terpadu untuk edukasi, pengumpulan, dan daur ulang sampah yang memberdayakan masyarakat
                            dalam menciptakan lingkungan berkelanjutan. Mulai perjalanan hijau Anda bersama kami.
                        </p>
    ...
    <section class="welcome-section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <h1 class="fw-bold mb-4">Selamat datang <span class="d-block">di <span
                                class="text-success">TrashEdu</span></span></h1>
                </div>
                <div class="col-lg-5">
                    <p class="lead text-muted" style="text-align: justify;">
                        TrashEdu adalah platform revolusioner yang mengubah cara kita memandang dan mengelola sampah. Kami
                        menghubungkan kesadaran lingkungan dengan solusi praktis untuk masa depan yang lebih bersih.
                    </p>
                </div>
            </div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="feature-card">
                                <div class="position-absolute rounded-circle"
                                    style="width: 150px; height: 150px; background: rgba(255,255,255,0.15); top: -40px; right: -40px;">
                                </div>
                                <div class="position-absolute rounded-circle"
                                    style="width: 100px; height: 100px; background: rgba(255,255,255,0.1); bottom: -30px; left: -30px;">
                                </div>
                                <div class="card-body text-white text-center position-relative">
                                    ...
                                    <p class="mb-3">Kumpulkan sampah yang kamu miliki, tukarkan jadi poin, dan raih
                                        berbagai hadiah menarik sambil jaga lingkungan.</p>
                                    <a href="{{ route('user.rewards.redeem') }}" class="btn btn-light btn-rounded">
                        ...
                        <div class="col-md-6">
                            <div class="feature-card" style="background: linear-gradient(135deg, #a8cfc4, #7aa89f);">
                                <div class="position-absolute rounded-circle"
                                    style="width: 180px; height: 180px; background: rgba(255,255,255,0.15); top: -40px; right: -40px; z-index:0;">
                                </div>
                                <div class="position-absolute rounded-circle"
                                    style="width: 120px; height: 120px; background: rgba(255,255,255,0.1); bottom: -30px; left: -30px; z-index:0;">
                                </div>
                                <div class="card-body text-white text-center position-relative" style="z-index:1;">
                                    <i class="fas fa-users fa-3x mb-3"></i>
                                    <h5 class="fw-bold">Quiz Edukatif</h5>
                                    <p class="mb-3">Uji pengetahuan lingkungan dengan quiz edukatif kami! Kompetisikan
                                        skor, raih poin, dan bergabung dengan komunitas peduli bumi.</p>
                                    <a href="{{ route('user.quizzes.index') }}" class="btn btn-light btn-rounded px-4">
                                        Pelajari Lebih Lanjut
                                    </a>
                                </div>
                            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 mb-5 mb-lg-0 position-relative text-center">
                    <div class="position-absolute top-50 start-50 translate-middle"
                        style="width:450px; height:450px; background:rgba(13,202,240,0.15); border-radius:50% 35% 60% 40%; z-index:0;">
                    </div>
                    <img src="{{ asset('images/foto.png') }}" class="shadow-lg position-relative w-100"
                        style="border-radius:60px 120px 40px 100px; z-index:1; max-width:600px; height:auto;"
                        alt="Foto Laut">
                    <div class="d-flex justify-content-center gap-3 bg-white shadow rounded-pill px-4 py-2 position-absolute"
                        ...
                        <img src="{{ asset('images/laravel.png') }}" style="height:24px;" alt="Logo1">
                        <img src="{{ asset('images/logowk.png') }}" style="height:24px;" alt="Logo2">
                    </div>
                </div>
                <div class="col-lg-6 ps-lg-5">
                    <div class="d-flex align-items-center mb-3">
                        <div style="width:50px; height:3px; background:#0dcaf0;" class="me-2"></div>
                        <span class="fw-semibold text-uppercase small" style="letter-spacing:.1em;">Inovasi dalam
                            Pengelolaan Sampah</span>
                    </div>
                    <h2 class="fw-bold mb-4" style="font-size:2.4rem; line-height:1.3;">
                        Transformasi Sampah Menjadi Nilai
                    </h2>
                    <p class="text-muted mb-4 fs-5">
                        Di TrashEdu, kami percaya setiap sampah memiliki nilai. Melalui teknologi dan kolaborasi, kami
                        mengubah limbah menjadi sumber daya yang bermanfaat untuk ekonomi sirkular.
                    </p>
                    <a href="{{ route('user.waste.submit') }}" class="btn btn-outline-info px-5 py-2 rounded-pill">Tukar
                        Sampahmu!</a>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="article-card border-0 shadow h-100">
                        ...
                        <div
                            style="background:#fff; padding:20px; position: relative; top:-40px; margin:0 15px; border-radius:8px;">
                            <p class="text-uppercase small text-muted mb-2">Edukasi Lingkungan</p>
                            <h5 class="fw-bold">5 Langkah Mudah Memulai Daur Ulang di Rumah</h5>
                            <p class="text-muted mt-2" style="font-size:15px;">
                                Pelajari cara memisahkan sampah organik dan anorganik, teknik pengomposan sederhana, dan
                                tips mengurangi sampah plastik dalam kehidupan sehari-hari.
                                Link: Baca Panduan Lengkap
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="article-card border-0 shadow h-100">
                        <img src="{{ asset('images/hijau.png') }}" class="w-100" alt="Residential"
                            style="height:250px; object-fit:cover;">
                        <div
                            style="background:#fff; padding:20px; position: relative; top:-40px; margin:0 15px; border-radius:8px;">
                            <p class="text-uppercase small text-muted mb-2">Teknologi Hijau</p>
                            <h5 class="fw-bold">Inovasi Teknologi dalam Pengolahan Sampah Modern</h5>
                            <p class="text-muted mt-2" style="font-size:15px;">
                                Temukan bagaimana teknologi AI dan IoT membantu meningkatkan efisiensi pengumpulan dan
                                pemilahan sampah di kota-kota besar Indonesia.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="article-card border-0 shadow h-100">
                        <img src="{{ asset('images/komunitas.png') }}" class="w-100" alt="Community"
                            style="height:250px; object-fit:cover;">
                        <div
                            style="background:#fff; padding:20px; position: relative; top:-40px; margin:0 15px; border-radius:8px;">
                            <p class="text-uppercase small text-muted mb-2">Komunitas</p>
                            <h5 class="fw-bold">Kisah Sukses Komunitas Daur Ulang Lokal</h5>
                            <p class="text-muted mt-2" style="font-size:15px;">
                                Inspirasi dari komunitas yang berhasil mengurangi 70% sampah di lingkungan mereka melalui
                                program edukasi dan bank sampah berbasis digital.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center text-center mb-5">
                <div class="col-lg-8">
                    ...
                    <p class="lead text-muted">Testimoni dari klien dan pelanggan yang telah merasakan manfaat layanan kami
                    </p>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="carousel-container">
                        <div id="testimonialCarousel" class="carousel slide" data-bs-ride="carousel">
                                        ...
                                        <div class="col-md-8 col-lg-10">
                                            <div class="testimonial-card">
                                                ...
                                                <p class="testimonial-text">
                                                    "Saya sangat terkesan dengan program TrashEdu. Berkat sistem poin yang
                                                    diterapkan, keluarga saya sekarang lebih semangat memilah sampah. Dalam
                                                    3 bulan, kami berhasil menukarkan 50kg sampah dengan voucher belanja!"
                                                </p>
                                                <div class="d-flex align-items-center">
                                                    <img src="https://randomuser.me/api/portraits/women/44.jpg"
                                                        alt="Avatar" class="author-avatar me-3">
                                                    <div>
                                                        <div class="author-name">Sarah Johnson</div>
                                                        <div class="author-position">Ibu Rumah Tangga</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-8 col-lg-10">
                                            <div class="testimonial-card">
                                                <div class="quote-icon">❝</div>
                                                <p class="testimonial-text">
                                                    "Sebagai pengusaha UMKM, program kemitraan TrashEdu membantu bisnis saya
                                                    menjadi lebih ramah lingkungan. Kami mengurangi biaya pengelolaan sampah
                                                    hingga 40% sambil mendapatkan reputasi sebagai bisnis berkelanjutan."
                                                </p>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="author-position">Pemilik Restoran</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-8 col-lg-10">
                                            <div class="testimonial-card">
                                                <div class="quote-icon">❝</div>
                                                <p class="testimonial-text">
                                                    "Workshop edukasi dari TrashEdu mengubah cara berpikir siswa-siswa kami.
                                                    Sekarang mereka menjadi agen perubahan di sekolah dan lingkungan rumah
                                                    masing-masing."
                                                </p>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="author-position">Guru Sekolah Dasar</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-8 col-lg-10">
                                            <div class="testimonial-card">
                                                <div class="quote-icon">❝</div>
                                                <p class="testimonial-text">
                                                    "Sistem pengumpulan sampah yang terintegrasi dengan aplikasi membuat
                                                    proses menjadi sangat mudah. Saya bisa menjadwalkan penjemputan sampah
                                                    daur ulang sesuai kebutuhan."
                                                </p>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="author-position">Warga Apartemen</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-8 col-lg-10">
                                            <div class="testimonial-card">
                                                <div class="quote-icon">❝</div>
                                                <p class="testimonial-text">
                                                    "TrashEdu tidak hanya menyediakan solusi, tapi juga membangun komunitas
                                                    yang peduli lingkungan. Saya mendapatkan banyak teman baru yang memiliki
                                                    visi sama untuk bumi yang lebih baik."
                                                </p>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="author-position">Mahasiswa Aktifis</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <!-- Navigation Buttons -->
                            <button style="margin-left: -33px" class="carousel-control-prev" type="button"
                                data-bs-target="#testimonialCarousel" data-bs-slide="prev">
                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            </button>
                            <button style="margin-right: -33px" class="carousel-control-next" type="button"
    ...
    <section class="faq-section">
        ...
        <div class="position-absolute bottom-0 end-0" style="z-index:0; pointer-events:none;">
            <i class="fas fa-leaf text-success" style="font-size:110px; opacity:0.06; transform:translate(40%,40%);"></i>
        </div>
