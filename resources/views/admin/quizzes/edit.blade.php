                                ...
                                <div class="col-12">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    value="{{ old('point_reward', $quiz->point_reward) }}" min="1"
                                                    required>
                                                @error('point_reward')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                                            value="1" {{ $quiz->is_active ? 'checked' : '' }}>
                                    ...
                                    <div id="questions-container">
                                        @foreach ($quiz->questions as $index => $question)
                                            <div class="question-card" data-index="{{ $index }}">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label text-dark-green fw-semibold">Pertanyaan <span
                                                            class="text-danger">*</span></label>
                                                    <textarea class="form-control" name="questions[{{ $index }}][question]" rows="2" required>{{ old('questions.' . $index . '.question', $question->question) }}</textarea>
                                                </div>

                                                <div class="row mb-3">
                                                    <div class="col-md-6">
                                                        <label class="form-label text-dark-green fw-semibold">Opsi A <span
                                                                class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <label class="form-label text-dark-green fw-semibold">Opsi B <span
                                                                class="text-danger">*</span></label>
                                                        <input type="text" class="form-control"
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-6">
                                                        <label class="form-label text-dark-green fw-semibold">Opsi C <span
                                                                class="text-danger">*</span></label>
                                                        <input type="text" class="form-control"
                                                    ...
                                                    <div class="col-md-6">
                                                        <label class="form-label text-dark-green fw-semibold">Opsi D <span
                                                                class="text-danger">*</span></label>
                                                        <input type="text" class="form-control"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <label class="form-label text-dark-green fw-semibold">Jawaban Benar
                                                        ...
                                                        <select class="form-select"
                                                            ...
                                                            <option value="a"
                                                                {{ old('questions.' . $index . '.correct_answer', $question->correct_answer) == 'a' ? 'selected' : '' }}>
                                                                A</option>
                                                            <option value="b"
                                                                {{ old('questions.' . $index . '.correct_answer', $question->correct_answer) == 'b' ? 'selected' : '' }}>
                                                                B</option>
                                                            <option value="c"
                                                                {{ old('questions.' . $index . '.correct_answer', $question->correct_answer) == 'c' ? 'selected' : '' }}>
                                                                C</option>
                                                            <option value="d"
                                                                {{ old('questions.' . $index . '.correct_answer', $question->correct_answer) == 'd' ? 'selected' : '' }}>
                                                                D</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label text-dark-green fw-semibold">Point <span
                                                                class="text-danger">*</span></label>
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <div class="mb-3">
                                        <img id="thumbnailPreview"
                                            src="{{ $quiz->thumbnail ? asset('storage/' . $quiz->thumbnail) : asset('images/default-quiz-thumbnail.jpg') }}"
...
@push('script')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Preview gambar saat thumbnail diganti
            ...
            // Ganti preview & disable input saat centang hapus thumbnail
            if (removeThumbnailCheckbox) {
                removeThumbnailCheckbox.addEventListener('change', function() {
                    if (this.checked) {
                        thumbnailPreview.src = '{{ asset('images/default-quiz-thumbnail.jpg') }}';
                        thumbnailInput.disabled = true;
                    } else {
                        thumbnailPreview.src =
                            '{{ $quiz->thumbnail ? asset('storage/' . $quiz->thumbnail) : asset('images/default-quiz-thumbnail.jpg') }}';
        ...
        <div class="question-card" data-index="${index}">
            ...
            <textarea class="form-control mb-3" name="questions[${index}][question]" rows="2" required></textarea>
            <input type="text" class="form-control mb-2" name="questions[${index}][option_a]" placeholder="Opsi A" required>
            <input type="text" class="form-control mb-2" name="questions[${index}][option_b]" placeholder="Opsi B" required>
            <input type="text" class="form-control mb-2" name="questions[${index}][option_c]" placeholder="Opsi C" required>
            <input type="text" class="form-control mb-2" name="questions[${index}][option_d]" placeholder="Opsi D" required>
            <select class="form-select mb-2" name="questions[${index}][correct_answer]" required>
            ...
            // Update urutan dan nama input
            function updateQuestionNumbers() {
                const cards = questionsContainer.querySelectorAll('.question-card');
                cards.forEach((card, i) => {
                    card.querySelector('h6').textContent = `Pertanyaan #${i + 1}`;
